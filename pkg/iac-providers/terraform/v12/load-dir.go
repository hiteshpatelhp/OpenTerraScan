...
import (
	...
	commons "github.com/tenable/openterrascan/pkg/iac-providers/terraform/commons"
	"go.uber.org/zap"
)
...
func (*TfV12) LoadIacDir(absRootDir string, options map[string]interface{}) (allResourcesConfig output.AllResourceConfigs, err error) {
	zap.S().Warn("There may be a few breaking changes while working with terraform v0.12 files. For further information, refer to https://github.com/tenable/openterrascan/releases/v1.3.0")
