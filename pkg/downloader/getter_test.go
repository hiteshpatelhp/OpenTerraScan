...
func TestGetURLSubDir(t *testing.T) {
	...
	table := []struct {
	...
	}{
		{
			...
			URL:        "github.com/tenable/openterrascan",
			dest:       someDest,
			wantURL:    "git::https://github.com/tenable/openterrascan.git",
			wantSubDir: "",
			wantErr:    nil,
		},
		{
			name:       "github url with subdir",
			URL:        "github.com/tenable/openterrascan//some-subdir",
			dest:       someDest,
			wantURL:    "git::https://github.com/tenable/openterrascan.git",
		...
		{
			name:       "github ssh url",
			URL:        "git@github.com:tenable/openterrascan.git//some-subdir",
			dest:       someDest,
			wantURL:    "git::ssh://git@github.com/tenable/openterrascan.git",
			wantSubDir: someSubdir,
			wantErr:    nil,
		},
		{
